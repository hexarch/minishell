...
INCLUDE = -IInclude/ -I/Users/hasik/goinfre/homebrew/Cellar/readline/8.2.1/include
endif
CC = gcc
...
$(NAME): $(OBJ)
ifeq ($(shell uname), Darwin)
	@$(CC) $(CFLAGS) $(OBJ) -lreadline -L /Users/hasik/goinfre/homebrew/Cellar/readline/8.2.1/lib -o $(NAME)
endif
